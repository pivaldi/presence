...
func TestMap(t *testing.T) {
	t.Run("Map on value transforms value", func(t *testing.T) {
		n := nullable.FromValue(42)
		result := nullable.Map(n, func(v int) string {
	...
	t.Run("Map with type conversion", func(t *testing.T) {
		n := nullable.FromValue("123")
		result := nullable.Map(n, func(v string) int {
			i, _ := strconv.Atoi(v)
			return i
		})
		assert.True(t, result.IsValue())
...
func TestMapOr(t *testing.T) {
	t.Run("MapOr on value transforms value", func(t *testing.T) {
		n := nullable.FromValue(10)
		result := nullable.MapOr(n, "default", func(v int) string {
	...
	t.Run("MapOr on unset returns default", func(t *testing.T) {
		var n nullable.Of[string]
		result := nullable.MapOr(n, 0, func(v string) int {
			return len(v)
		})
...
func TestFlatMap(t *testing.T) {
	...
	t.Run("FlatMap chaining", func(t *testing.T) {
		n := nullable.FromValue("100")
		result := nullable.FlatMap(n, func(s string) nullable.Of[int] {
			i, _ := strconv.Atoi(s)
			return nullable.FromValue(i)
		})
		result2 := nullable.FlatMap(result, func(i int) nullable.Of[string] {
			if i > 50 {
				return nullable.FromValue("large")
			}
			return nullable.FromValue("small")
		})
...
func TestFilter(t *testing.T) {
	...
	t.Run("Filter on value that passes predicate", func(t *testing.T) {
		n := nullable.FromValue(42)
		result := nullable.Filter(n, isPositive)
		assert.True(t, result.IsValue())
		assert.Equal(t, 42, result.MustGet())
	})
...
func TestOr(t *testing.T) {
	t.Run("Or returns first value", func(t *testing.T) {
		a := nullable.FromValue("first")
		b := nullable.FromValue("second")
		c := nullable.FromValue("third")
		result := nullable.Or(a, b, c)
		assert.Equal(t, "first", result.MustGet())
	})

	t.Run("Or skips null and returns first value", func(t *testing.T) {
		a := nullable.Null[string]()
		b := nullable.FromValue("second")
		c := nullable.FromValue("third")
		result := nullable.Or(a, b, c)
	...
	t.Run("Or skips unset and returns first value", func(t *testing.T) {
		var a nullable.Of[int]
		b := nullable.FromValue(42)
		result := nullable.Or(a, b)
		assert.Equal(t, 42, result.MustGet())
	})

	t.Run("Or skips null and unset", func(t *testing.T) {
		var a nullable.Of[string]
		b := nullable.Null[string]()
		c := nullable.FromValue("third")
		result := nullable.Or(a, b, c)
...
func TestInterfaceCompliance(t *testing.T) {
	t.Run("Of implements NullableI with new methods", func(t *testing.T) {
		val := nullable.FromValue("test")
		var n nullable.NullableI[string] = &val
...
func TestCombinedOperations(t *testing.T) {
	t.Run("Map then Filter", func(t *testing.T) {
		n := nullable.FromValue("hello")
		mapped := nullable.Map(n, func(s string) int {
			return len(s)
		})
		filtered := nullable.Filter(mapped, func(i int) bool {
			return i > 3
		})
	...
	t.Run("Filter then Map", func(t *testing.T) {
		n := nullable.FromValue(10)
		filtered := nullable.Filter(n, func(i int) bool {
			return i > 5
		})
		mapped := nullable.Map(filtered, func(i int) string {
	...
	t.Run("Or with Map fallback", func(t *testing.T) {
		primary := nullable.Null[string]()
		secondary := nullable.FromValue("backup")

		result := nullable.Or(primary, secondary)
		mapped := nullable.Map(result, strings.ToUpper)
